...
int main(int argc, char* argv[])
{
  ...
  char message[BUFSIZ];  /* BUFSIZ is a default size defined in stdio.h */
  ...
  */
  if (myrank != 0) {  /* this is _NOT_ the master process */
    /* create a message to send, in this case a character array */
    sprintf(message, "Come-in Chen, this is process %d!", myrank);
